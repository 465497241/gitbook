```php
原贴地址(在码云):https://git.oschina.net/do_ta/codes/h3vew5x0jq7ndb6fsa48m48
...
<?php
	function index(){
		$img = new ImageController('uploads');
		$thumb = $img->thumb(str_replace('/uploads','', $newpath),1080,1080);
	}
	...
	class ImageController{
		...
		private function kidOfImage($srcImg, $size, $imgInfo){
			...
			if($otsc >=0 && $otsc <= imagecolorstotal($srcImg)){
				...
				$newt=imagecolorallocate($newImg, 255, 255, 255);
