```php
原贴地址(在码云):https://git.oschina.net/JsRan/codes/d1bcyajxlo7gqzv04hkin48
...
class JScUrl
{
	...
	public static function open($url, $method = 'GET')
	{
		...
		switch ($method) {
			...
			break;
			case 'PUT':
				self::$opts[CURLOPT_PUT] = true;
				self::$opts[CURLOPT_INFILE] = null;
				self::$opts[CURLOPT_INFILESIZE] = null;
			break;
			case 'GET': # 设置常规GET请求
			default:
	...
	{
		if(!empty($data) && self::$opts[CURLOPT_POST])
