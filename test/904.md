```php
原贴地址(在码云):https://git.oschina.net/doyourbest/codes/kj5bc3hef6ulo1pw4yv8i
...
<?php
/** 使用cookie实现的购物车,可以在tp中作为工具类使用.功能较简单,算是一个大体框架吧,希望大家多多指教
    购物车类
    实现对购物车里边商品的添加、删除操作
    author hua & hui
*/
class Cart{
    ...
    */
    ...
    /**
    将商品添加到购物车里边
    @param $product  array('product_id'=>'10','product_name'=>'iphone8','product_price'=>'5000','product_buy_number'=>'1','product_total_price'=>5000);
    更正式点应该将商品的附加属性也存入cookie,以便区分不同属性的同种商品(譬如黑色和白色的同型号iphone)*/
