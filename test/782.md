```php
原贴地址(在码云):https://git.oschina.net/zunyunkeji/codes/k0imvb57g4sp9z6o2tljn
...
<body>
<div class="warp">
    <h1 style="text-align:center;">系统数据库数据字典</h1>
	<h3 style="text-align:center;">更新日期：<?php echo date('Y-m-d');?></h1>
<?php echo $html; ?>
</div>
</body>
</html>
