```php
原贴地址(在码云):https://git.oschina.net/zunyunkeji/codes/uvq7mjz3cxy8taog1hfkb
...
//概率算法,6个奖项
$prize_arr =[
    '0' => ['id'=>1,'prize'=>'iphone6','v'=>1],
    '1' => ['id'=>2,'prize'=>'数码相机','v'=>5],
    '2' => ['id'=>3,'prize'=>'音箱设备','v'=>10],
    '3' => ['id'=>4,'prize'=>'50Q币','v'=>24],
    '4' => ['id'=>5,'prize'=>'10Q币','v'=>60],
    '5' => ['id'=>6,'prize'=>'1Q币','v'=>1900],
];
