```php
原贴地址(在码云):https://git.oschina.net/lanseyujie/codes/5gcp6qauyr9wteb74ls2x60
...
/** 
 * PHP读取纯真ip数据库
 * 纯真IP地址数据库（官方下载）http://www.cz88.net/fox/ipdat.shtml
 */
class ipquery
{
    var $fh;    //IP数据库文件句柄
    ...
    function __construct() {
        global $blogpath;
        $this->fh = fopen($blogpath.'zb_users/theme/Compass/plugin/qqwry/qqwry.dat', 'rb');  //qqwry.dat文件
    ...
    function ip2addr($ip) {
        ...
        //GBK编码转UTF-8码并去除无信息时显示的CZ88.NET
        foreach ($location as $k => $v) {
            //$location[$k] = str_replace('CZ88.NET', '', iconv('gb2312', 'utf-8', $v));
            $location[$k] = str_replace('CZ88.NET', '', iconv('gbk', 'utf-8', $v));
        }
