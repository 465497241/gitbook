```php
原贴地址(在码云):https://git.oschina.net/hia/codes/z2y39sgp5e74rknhtifx8
...
class qq{
    ...
    function get_user_info($token, $open_id)
    {
        ...
        $info1['sex']  = $info['gender'];
        $info1['age']    = $info['year'];
        $info1['img']  = $info['figureurl_qq_2'];
        $info1['unid']  = $open_id;
    ...
    public function getinfo($code){
        ...
        $userinfo = $this->get_user_info($token['access_token'],$open_id['openid']);
        return  $userinfo;
    }
